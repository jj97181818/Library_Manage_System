            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 back">
                        <form method="POST" action="log_employee.php">
                            <p>姓名：<input type="text" name="ename"></p>
                            <p>性別：<input type="text" name="sex"></p>
                            <p>員工編號：<input type="text" name="eid"></p>
                            <p>分機號碼：<input type="text" name="extension"></p>
                            <p>組別代碼：<input type="text" name="dnum"></p>
                            <p>上司編號：<input type="text" name="super_eid"></p>
                        ...
                        <?php
                            ...
                            if (isset($_POST['ename']) && isset($_POST['sex']) && isset($_POST['eid']) && isset($_POST['extension']) && isset($_POST['dnum']) && isset($_POST['super_eid'])) {  #如果欄位都有填
                                ...
                                $super_eid = get_post($conn, 'super_eid');
                                $query = "INSERT INTO EMPLOYEE (ename, sex, eid, extension, dnum, super_eid) VALUES ('$ename', '$sex', '$eid', '$extension', '$dnum', '$super_eid')";
